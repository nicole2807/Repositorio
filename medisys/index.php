...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Login Control de Inventario IZS</title>
  ...
  <body class="login-page bg-login">
    <div class="login-box">
      <div style="color:#3c8dbc" class="login-logo">
        <img style="margin-top:-12px" src="assets/img/logo-izs.png" alt="Logo" height="50"> <b>Control Inventario Inversiones Zona Sur</b>
      </div><!-- /.login-logo -->
      <?php  
